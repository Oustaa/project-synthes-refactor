...
export const getStore = createAsyncThunk("get/store", async () => {
  const resp = await axios.get(`${import.meta.env.VITE_BASE_URL}/stores`, {
    headers: {
...
export const getCategories = createAsyncThunk(
  "get/store/products",
  async () => {
    const resp = await axios.get(`${import.meta.env.VITE_BASE_URL}/categories`);
...
export const getOrders = createAsyncThunk("get/store/orders", async () => {
  const resp = await axios.get(
    `${import.meta.env.VITE_BASE_URL}/orders/store`,
    {
      headers: {
        Authorization: localStorage.getItem("token"),
      },
